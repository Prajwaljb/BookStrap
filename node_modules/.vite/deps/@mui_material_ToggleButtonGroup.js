...
var ToggleButtonGroupRoot = styled_default("div", {
  ...
  ...theme.focusVisible && {
    ...
    [`& .${toggleButtonGroupClasses_default.grouped}.${buttonBaseClasses_default.focusVisible}`]: {
      zIndex: 1
    }
  },
  variants: [{
...
var ToggleButtonGroup = React2.forwardRef(function ToggleButtonGroup2(inProps, ref) {
  ...
  const rovingContainerProps = rovingTabIndexRoot.getContainerProps(ref, other.onFocus, other.onKeyDown);
  return (0, import_jsx_runtime.jsx)(ToggleButtonGroupRoot, {
    ...
    children: (0, import_jsx_runtime.jsx)(RovingTabIndexContext.Provider, {
      value: rovingTabIndexRoot,
