...
function Ve({
  ...
  const E = he(t), D = (0, import_react.useMemo)(
    ...
    [e]
  ), [v, U] = (0, import_react.useState)(null), m = Ie(v, i), {
    getCellBounds: G,
    getEstimatedSize: p,
...
function Le({
  ...
  const h = he(c), z = (0, import_react.useMemo)(
    ...
    [f]
  ), [u, j] = (0, import_react.useState)(null), T = Te(i), E = (0, import_react.useMemo)(() => T ? (b) => i.getRowHeight(b) ?? i.getAverageRowHeight() : i, [T, i]), {
    getCellBounds: D,
    getEstimatedSize: v,
    scrollToIndex: U,
