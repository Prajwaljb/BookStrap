...
function useRovingTabIndexRoot(params) {
  ...
  const [previousActiveItemIdProp, setPreviousActiveItemIdProp] = React2.useState(activeItemIdProp);
  ...
  const getContainerProps = React2.useCallback((ref, onFocusProp, onKeyDownProp) => {
    const onFocus = (event) => {
      onFocusProp?.(event);
      const snapshot = getNavigableItemsSnapshot(itemMapRef.current);
...
//# sourceMappingURL=chunk-CRPAFQIC.js.map
